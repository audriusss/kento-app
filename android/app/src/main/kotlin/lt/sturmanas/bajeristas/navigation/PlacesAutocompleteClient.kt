...
object PlacesAutocompleteClient {
    ...
    /**
     * Returns up to [MAX_SUGGESTIONS] autocomplete predictions for [query].
     *
     * Supports:
     ...
     *
     * Results are biased to Lithuania (`LT`).
    ...
    suspend fun getSuggestions(
        ...
        return try {
            ...
            val request = FindAutocompletePredictionsRequest.builder()
                ...
                .build()
            val response = client.findAutocompletePredictions(request).awaitResult()
            response.autocompletePredictions.take(MAX_SUGGESTIONS)
        } catch (e: Exception) {
